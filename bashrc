...
alias ore_db1='rename db1.ore && ssh -f -N db1.ore.starfishsolutions.com && psql -h localhost -p 10000 -U starfish -d ea_ore'
alias ore_sfadmin_db1='rename sfadmin-db1-ore && ssh -f -N sfadmin-db1.ore && psql -h localhost -p 10001 -U starfish -d sfadmin_ea_ore'
